  ...
  public function clear_search()
	...
	public function get_status_report_export()
		...
		$res_data = $this->reportmodel->get_status_report_export($frmDate,$toDate,$status,$paguthi,$ward_id);
		 ...
		 $header = array("Name", "FatherName/HusbandName/GuardianName", "DOB", "Gender"," D.No","Door No. & Address", "Pincode", "PhoneNo", "WhatsApp No", "Religion", "Constituency", "Paguthi", "OfficeName", "Ward", "Booth", "SeekerType", "GrievanceType", "SubCategory", "Grievence Status", "CreatedDate", "UpdatedDate");
		 fputcsv($file, $header);
		...
		public function get_category_report_export()
		{
		 ...
		 if(empty($ward_id)){
			 ...
			 $file = fopen('php://output', 'w');
			 $header = array( "Name", "Father Name/Husband Name/Guardian Name", "DOB", "Gender", "D.No" ,"Door No. & Address", "Pincode", "Phone No", "WhatsApp No", "Religion", "Constituency", "Paguthi", "Office Name", "Ward", "Booth"," Seeker Type",
	...
	public function get_meeting_report_export()
	{
	 ...
	 if(empty($ward_id)){
		 ...
		 $file = fopen('php://output', 'w');
			...
			$header = array("Name","FatherName/HusbandName/GuardianName","DOB", "Gender", "D.No","Door No. & Address","Pincode", "PhoneNo", "WhatsApp No", "Religion", "Constituency" ,"Paguthi", "OfficeName", "Ward", "Booth", "Details", "Meeting Status","CreatedDate" ,"UpdatedDate");
		 fputcsv($file, $header);
		 foreach ($res_data->result_array() as $key => $value)
		 {
			 fputcsv($file, $value);
...
public function get_birthday_report_export()
{
 ...
 header("Content-Type: application/csv;");
	 ...
	 $file = fopen('php://output', 'w');
	 $header = array("Name","FatherName/HusbandName/GuardianName","DOB", "Gender", "D.No","Door No. & Address","Pincode", "PhoneNo", "WhatsApp No", "Religion", "Constituency" ,"Paguthi", "OfficeName", "Ward", "Booth","Sent On Month Of" ,"Sent On Year Of", "Letter Sent On");
	 fputcsv($file, $header);
	 foreach ($res_data->result_array() as $key => $value)
	 {
		 fputcsv($file, $value);
...
public function get_festival_report_export()
{
 ...
 header("Content-Type: application/csv;");
	 ...
	 $file = fopen('php://output', 'w');
	  $header = array("Name","FatherName/HusbandName/GuardianName","DOB", "Gender", "D.No","Door No. & Address","Pincode", "PhoneNo", "WhatsApp No", "Religion", "Constituency" ,"Paguthi", "Office Name", "Ward", "Booth","Festival Name" ,"Sent On Year Of", "Letter Sent On");
	 fputcsv($file, $header);
	 foreach ($res_data->result_array() as $key => $value)
	 {
		 fputcsv($file, $value);
...
public function get_constituent_report_export()
{
	 ...
	 $file = fopen('php://output', 'w');
	 $header = array("Name"," Father Name/Husband Name/Guardian Name", "DOB", "Gender", "D.No", "Door No. & Address", "Pincode", "Phone No", "WhatsApp No", "Mail Id", "Religion", "Constituency", "Paguthi", "Office Name", "Ward", "Booth", "Voter Type",
	...
	public function get_video_report_export(){
			...
			$file = fopen('php://output', 'w');
			$header = array("Name", "Father Name/Husband Name/Guardian Name", "DOB", "Gender", "D.No" , "Door No. & Address", "Pincode", "Phone No", "WhatsApp No", "Mail Id", "Religion", "Constituency", "Paguthi", "Office Name", "Ward", "Booth"," Video Link", "Created Date");
			fputcsv($file, $header);
			foreach ($res_data->result_array() as $key => $value)
			{
				fputcsv($file, $value);
