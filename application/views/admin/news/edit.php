               ...
               <form id="myformsection" action="<?php echo base_url(); ?>news/update_news" method="post" enctype="multipart/form-data">
                  ...
                  <div class="item form-group">
					...
					<div class="item form-group">
                     ...
                     <div class="col-md-4 col-sm-4">
						<input type="text" class="form-control" placeholder="News Date" id="news_date" name="news_date" value="<?php $date=date_create($rows->news_date);echo date_format($date,"d-m-Y");  ?>">
                     </div>
                  </div>
				  <div class="item form-group">
