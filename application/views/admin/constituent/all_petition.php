         ...
         <div class="x_panel">
               ...
               <div class="x_content">
								...
								<div class="col-md-12 col-sm-12" style="padding:0px;">
										<div class="col-md-4 col-sm-4"><input class="form-control" id="search" name="p_search" type="text" placeholder="Search Full name, Petition no,reference no " value="<?= $search ?>" /></div>
