  ...
  <div  class="right_col" role="main">
   <div class="">
      <div class="col-md-12 col-sm-12 ">
         <div class="x_panel">
					 <div class="">
							<h2><i class="fa fa-file-word-o"></i> list of Petition</h2>

					 </div>
               <div class="x_content">
								 <form method='post' action="<?= base_url() ?>constituent/all_petition" >
								<div class="col-md-12 col-sm-12" style="padding:0px;">
										<div class="col-md-4 col-sm-4"><input class="form-control" id="search" name="search" type="text" placeholder="Search Full name, Petition no,reference no " value="<?= $search ?>" /></div>
										<div class="col-md-3 col-sm-2"><input class="btn btn-success" type='submit' name='submit' value='Search'>
											<?php if ($search_value!='') { ?>
											<a href="<?php echo base_url(). "constituent/all_petition"; ?>" class="btn btn-danger">Clear All</a>
											<?php } ?>
										</div>
