               ...
               <div class="x_content">
								...
								<div class="col-md-12 col-sm-12" style="padding:0px;">
										<div class="col-md-4 col-sm-4">
											<input class="form-control" id="search" name="e_search" type="text" placeholder="Search using  name, Petition no Or reference " value="<?= $e_search; ?>" required oninvalid="this.setCustomValidity('ENTER THE NAME OR PETITION NO OR REFERENCE')"/>
										</div>
