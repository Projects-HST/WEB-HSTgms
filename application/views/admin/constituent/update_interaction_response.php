        ...
        <div class="x_panel" class="interaction_div">
           ...
           <div class="x_content">
             <div class="form-group row interaction_div">
               <?php  foreach($res as $rows_question){ ?>
                 ...
                 <div class="col-md-2 col-sm-9 mb_20">
                   ...
                   <select class="form-control" name="question_response[]" id="status_<?php echo $rows_question->id; ?>">
                     <option value="Y">YES</option>
                     <option value="N">NO</option>
                   </select>
                   <?php foreach($res_interaction as $rows){ ?>
                    <script>$('#status_<?php echo $rows->question_id; ?>').val('<?php  echo $rows->question_response; ?>');</script>
                     <?php  } ?>
                 </div>
