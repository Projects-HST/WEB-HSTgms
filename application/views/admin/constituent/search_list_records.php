...
<div  class="right_col" role="main">
   <div class="">
      <div class="col-md-12 col-sm-12 ">
         <div class="x_panel">
            <div class="x_title">
                <h2>List of constituent</h2> <span style="float:right;"><a class="badge-success" style="padding:10px;" href="<?= base_url() ?>constituent/export_constituent"> Export </a></span>
			...
			<div class="col-md-12 col-sm-12" style="padding:0px;">
				  <div class="col-md-3 col-sm-4"><input class="form-control" id="search" name="search" type="text" placeholder="Search keyword" value="<?= $search ?>" /></div>
