             ...
             <tbody>
               ...
               foreach($result as $rows){ ?>
                ...
                <td><?php if(is_null($rows['wish_id'])){ ?>
                  <a href="<?php echo base_url(); ?>constituent/birthday_update/<?php echo base64_encode($rows['id']*98765);?>" onclick="return confirm('ARE YOU SURE YOU WANT TO UPDATE STATUS ?');" style="font-size:13px;font-weight:bold;color:#ee0606;">NOT SENT</a>
              <?php  }else{ ?>
                <p>SENT</p>
              <?php  } ?></td>
                <!-- <td></td> -->
