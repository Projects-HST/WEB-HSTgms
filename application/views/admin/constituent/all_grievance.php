         ...
         <div class="x_panel">
               ...
               <div class="x_content">
								...
								<div class="col-md-12 col-sm-12" style="padding:0px;">
										<div class="col-md-6 col-sm-4"><input class="form-control" id="search" name="a_search" type="text" placeholder="Search using  name, Petition no,reference " value="<?php echo $a_search; ?>" /></div>
