        ...
        <div class="col-md-12 col-sm-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <a href="<?php echo base_url(); ?>report/get_status_report_export" class="btn btn-export pull-right">Export</a>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    ...
                    <div class="">
                        <div class="col-md-12 col-sm-12" style="padding: 0px;">
                            <div class="col-md-3 col-sm-3">
                              <p style="margin-top:20px;">Total records : <?php echo $total_records; ?></p>
                            </div>
